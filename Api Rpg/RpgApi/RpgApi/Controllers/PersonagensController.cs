...
namespace RpgApi.Controllers
{
    ...
    public class PersonagensController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Add([FromBody]Personagem novoPersonagem)
        {
            try
            {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody]Personagem novoPersonagem)
        {
            try
            {
                if (novoPersonagem.PontosVida > 100)
        ...
        public async Task<IActionResult> RestaurarPontosVidaAsync([FromBody]Personagem p)
        {
            try
            {
        ...
        public async Task<IActionResult> AtualizarFotoAsync([FromBody]Personagem p)
        {
            try
            {
        ...
        public async Task<IActionResult> ZerarRankingAsync([FromBody]Personagem p)
        {
            try
            {
                Personagem pEncontrado =
